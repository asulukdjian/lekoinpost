...
file = URI.open('https://res.cloudinary.com/dwdtcwivm/image/upload/v1606302988/muxndtzrtx4rbhux3baw.jpg')
...
file = URI.open('https://res.cloudinary.com/dwdtcwivm/image/upload/v1606303485/znuzjxmciljttjmrj75w.jpg')
...
file = URI.open('https://res.cloudinary.com/dwdtcwivm/image/upload/v1606303303/au7x916zriivrnapplp0.jpg')
garden3.photos.attach(io: file, filename: "Paul municipal garden view.png", content_type: 'image/jpg')
file = URI.open('https://res.cloudinary.com/dwdtcwivm/image/upload/v1606303793/bwppp03cbuv8fpljwryq.jpg')
